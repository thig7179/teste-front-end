        ...
        <v-card>
          ...
          <v-list>
            ...
            <v-list-item router to="/studio">
              ...
              <v-list-item-title>IcaseiFront Studio</v-list-item-title>
            </v-list-item>
        ...
        <v-list dense nav class="py-0" tag="div">
          ...
          >
            <v-app-bar-nav-icon
              ...
              class="mr-5"
            ></v-app-bar-nav-icon>
            <v-toolbar-title class="font-weight-bold">IcaseiFront</v-toolbar-title>
          </v-list-item>
...
export default {
  data: () => ({
    ...
    items: [
      ...
      {
        header: 'MORE FROM IcaseiFront',
        pages: [
          {
            title: 'IcaseiFront Premium',
            link: '#vp',
            icon: 'mdi-youtube'
          },
          {
